...
type AdmissionSettings={
  ...
  faceVerification:{configured:boolean;autoApprove:boolean;autoReject:boolean;approveThreshold:number;reviewThreshold:number;detectionThreshold:number;referenceDocumentKeys:string[]}
...
export function SettingsPage(){
  ...
  return <><Header title="Configurações" subtitle="Admissão Digital"/><div className={styles.module}><div className={styles.content}>
    ...
    <section className={styles.card} data-admission-tour="settings-face-policy" style={{marginBottom:16}}>
