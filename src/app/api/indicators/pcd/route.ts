...
export async function GET(req: NextRequest) {
  ...
  const data = await prisma.pCDIndicator.findMany({
    where,
    include: { unit: true },
...
export async function POST(req: NextRequest) {
  ...
  const data = await prisma.pCDIndicator.upsert({
    where: { unitId_year_month: { unitId: body.unitId, year: body.year, month: body.month } },
    update: { totalEmployees: body.totalEmployees, metaPercentage: body.metaPercentage, currentPcd: body.currentPcd },
    create: { unitId: body.unitId, year: body.year, month: body.month, totalEmployees: body.totalEmployees, metaPercentage: body.metaPercentage, currentPcd: body.currentPcd },
    include: { unit: true },
  })
