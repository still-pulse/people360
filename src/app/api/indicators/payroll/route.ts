...
export async function GET(req: NextRequest) {
  ...
  const data = await prisma.payrollIndicator.findMany({
    where,
    include: { unit: true },
...
export async function POST(req: NextRequest) {
  ...
  const data = await prisma.payrollIndicator.upsert({
    where: { unitId_year_month: { unitId: body.unitId, year: body.year, month: body.month } },
    update: { totalPayroll: body.totalPayroll, totalEmployees: body.totalEmployees },
    create: { unitId: body.unitId, year: body.year, month: body.month, totalPayroll: body.totalPayroll, totalEmployees: body.totalEmployees },
    include: { unit: true },
  })
