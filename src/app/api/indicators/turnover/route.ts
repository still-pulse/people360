...
export async function POST(req: NextRequest) {
  ...
  const data = await prisma.turnoverIndicator.upsert({
    where: { unitId_year_month: { unitId: body.unitId, year: body.year, month: body.month } },
    update: { admissions: body.admissions, dismissals: body.dismissals, headcountStart: body.headcountStart, headcountEnd: body.headcountEnd },
    create: { unitId: body.unitId, year: body.year, month: body.month, admissions: body.admissions, dismissals: body.dismissals, headcountStart: body.headcountStart, headcountEnd: body.headcountEnd },
    include: { unit: true },
  })
