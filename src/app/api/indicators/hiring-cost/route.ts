...
export async function GET(req: NextRequest) {
  ...
  const data = await prisma.hiringCostIndicator.findMany({
    where,
    include: { unit: true },
...
export async function POST(req: NextRequest) {
  ...
  const data = await prisma.hiringCostIndicator.upsert({
    where: { unitId_year_month: { unitId: body.unitId, year: body.year, month: body.month } },
    update: { totalCost: body.totalCost, totalHires: body.totalHires },
    create: { unitId: body.unitId, year: body.year, month: body.month, totalCost: body.totalCost, totalHires: body.totalHires },
    include: { unit: true },
  })
