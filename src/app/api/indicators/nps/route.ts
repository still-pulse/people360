...
export async function GET(req: NextRequest) {
  ...
  const data = await prisma.npsIndicator.findMany({
    where,
    include: { unit: true },
...
export async function POST(req: NextRequest) {
  ...
  const data = await prisma.npsIndicator.upsert({
    where: { unitId_year_month: { unitId: body.unitId, year: body.year, month: body.month } },
    update: { promoters: body.promoters, neutrals: body.neutrals, detractors: body.detractors, totalRespondents: body.totalRespondents },
    create: { unitId: body.unitId, year: body.year, month: body.month, promoters: body.promoters, neutrals: body.neutrals, detractors: body.detractors, totalRespondents: body.totalRespondents },
    include: { unit: true },
  })
